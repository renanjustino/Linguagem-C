...
/*
O valor de 'n' demonstra a quantidade de entradas que existirá no vetor alocado dinamicamente.
No auxílio dessa representaçao, o malloc aloca diretamente a quantidade de bytes, portanto, temos que
multiplicar a quantidade desejada('n') pela quantidade de bytes utilizada pelo tipo desejado, 
então realizando o uso do sizeof(double) que voltara o valor de 8 bytes, neste caso.
*/
