...
int main() {
  ...
  printf("Endereço utilizando &a: %d\n", &a);
  printf("Endereço utilizando p: %d\n", p);
  printf("Digite um novo valor para a variavel: ");
  scanf("%d", p);
  printf("Novo valor variavel a: %d\n", *p);
  
  for( i = 0; i < 5; i++){
    if(*v == 10){
      printf("Digite um novo valor para a posiçao %d do vetor: ", i + 1);
      scanf("%d", v);
    }
    v++;
  }
  ...
  v = &val;
  printf("\nMapa de memoria:\n");
  printf("\nValores no ponteiro val: ");
  for(i = 0; i < 5; i++){
    printf("%d ", *v);
    v++;
  }
  v = &val;
  printf("\nPosiçoes de memoria val: ");
  for( i = 0; i < 5; i++){
    printf("%d ", v);
    v++;
  }
